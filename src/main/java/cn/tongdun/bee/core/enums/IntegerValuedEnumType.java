package cn.tongdun.bee.core.enums;
 ...
 */
public class IntegerValuedEnumType<T extends BaseIntegerEnum> implements UserType, ParameterizedType {
    ...
    public void setParameterValues(Properties parameters) {
        ...
        setDefaultValue(Integer.parseInt(parameters.getProperty("defaultValue")));
    }
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, SharedSessionContractImplementor session, Object owner)
        ...
        for(BaseIntegerEnum stringEnum : returnedClass().getEnumConstants()) {
            if (stringEnum.getValue().equals(value)) {
                return value;
            }
        }
    ...
    public void nullSafeSet(PreparedStatement st, Object value, int index, SharedSessionContractImplementor session)
        ...
        if (value == null) {
            ...
            st.setInt(index, ((BaseIntegerEnum) value).getValue());
        }
    }
